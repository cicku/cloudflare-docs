...
Note that certain browser extensions that are capable of controlling WebRTC, may also create a conflict with browser isolation. You should also verify the extension settings and modify accordingly.
